          ...
          <div className="max-w-container mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Through strategic partnerships and dedicated initiatives, we've
                made lasting contributions to communities across South Africa,
            ...
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-8 lg:p-12">
                ...
                <p className="text-muted-foreground text-lg mb-6 max-w-2xl mx-auto">
                  Join us in making a difference. Together, we can create
                  sustainable solutions that empower communities and drive

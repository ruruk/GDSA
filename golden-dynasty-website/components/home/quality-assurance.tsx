...
import { Shield, Award, CheckCircle, Settings, Headphones, FileCheck } from "lucide-react"
...
const qualityFeatures = [
  ...
  },
  {
    ...
    description: "Comprehensive testing documentation verifying product performance and safety specifications.",
  },
  {
    icon: CheckCircle,
    title: "Routine Test Certificate",
    description: "Regular quality testing protocols ensuring consistent product reliability and performance.",
  },
]
...
const services = [
  {
    ...
    description: "Tailored solutions designed according to your specific requirements and applications.",
  },
  {
    icon: Headphones,
    title: "After-Sale Support",
    description: "Comprehensive technical assistance and support services for all our products.",
  },
]
    ...
    <section className="py-20 bg-gradient-to-br from-background via-muted/30 to-background">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Quality Assurance</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            As well as offering IEC Standard products, we also offer custom made products according to the client's
            specific requirements. After-sale services including technical assistance will also be provided upon request
            from our clients.
          </p>
        </div>
        ...
        {/* Certifications Grid */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center mb-8 text-foreground">Our Quality Certifications</h3>
        ...
        <div className="bg-card/50 rounded-3xl p-8 md:p-12 border border-border">
          <h3 className="text-2xl font-bold text-center mb-8 text-foreground">Additional Services</h3>
        ...
        <div className="text-center mt-12">
          <div className="inline-flex items-center gap-3 bg-golden/5 border border-golden/20 rounded-full px-6 py-3">
            <Shield className="w-5 h-5 text-golden" />
            <span className="text-sm font-medium text-foreground">Certified Quality Standards Since 1997</span>
          </div>
        </div>
      </div>
    </section>
